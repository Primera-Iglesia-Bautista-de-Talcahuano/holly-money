...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-surface p-6 shadow-2xl transition ease-in-out data-open:animate-in data-open:duration-500 data-closed:animate-out data-closed:duration-300",
  {
    variants: {
      side: {
